...
def generar_cadenas_2(alfabeto: [], longitud: int):
    cadenas = alfabeto.copy()
    if longitud == 0:
        return ['ε']
    elif longitud == 1:
...
if __name__ == '__main__':
    ...
    print("Hace parte del lenguaje (Con regla): ",
          verificar_cadena_cadena(input("Ingrese una palabra que empiece con f: "), cadenas))
